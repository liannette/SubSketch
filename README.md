# SubSketch
BGC subcluster visualizations with ClusterClue integration

SubSketch creates publication-ready  SVG visualizations and HTML reports for biosynthetic gene clusters (BGCs) and ClusterClue subcluster motifs. Generate figures showing:
